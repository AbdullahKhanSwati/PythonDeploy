...
#                     # Save the image to a file in the same directory
#                     image_filename = "uploaded_image.png"  # Choose a filename and extension
#                     image_path = os.path.join(app.root_path, image_filename)
                    
#                     with open(image_path, 'wb') as image_file:
#                         image_file.write(image_data)

#                     # Return the URL of the saved image in the response
#                     image_url = f"{request.url_root}{image_filename}"
